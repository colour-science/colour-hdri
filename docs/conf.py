# -*- coding: utf-8 -*-
#
# colour-hdri documentation build configuration file, created by
...
version = '{0}.{1}'.format(colour_hdri.__major_version__,
                           colour_hdri.__minor_version__)
# The full version, including alpha/beta/rc tags.
release = str(colour_hdri.__version__)
...
htmlhelp_basename = 'ColourHDRIDoc'
...
latex_documents = [
    ('index', 'Colour_HDRI.tex', u'Colour - HDRI Documentation',
