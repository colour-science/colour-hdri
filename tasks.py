...
APPLICATION_NAME = colour_hdri.__application_name__

APPLICATION_VERSION = colour_hdri.__version__

PYTHON_PACKAGE_NAME = colour_hdri.__name__

PYPI_PACKAGE_NAME = 'colour-hdri'
...
def requirements(ctx):
    ...
    ctx.run('poetry export -f requirements.txt --without-hashes --dev '
            '--extras "optional plotting" -o requirements.txt')
