...
# -*- coding: utf-8 -*-
"""
Defines the unit tests for the :mod:`colour_hdri.models.dng` module.
...
interpolated_matrix` definition.
        ...
        np.testing.assert_almost_equal(
            interpolated_matrix(2850, 2850, 6500, M_COLOR_MATRIX_1,
                                M_COLOR_MATRIX_2),
            M_COLOR_MATRIX_1,
            decimal=7)

        np.testing.assert_almost_equal(
            interpolated_matrix(1000, 2850, 6500, M_COLOR_MATRIX_1,
                                M_COLOR_MATRIX_2),
            M_COLOR_MATRIX_1,
            decimal=7)

        np.testing.assert_almost_equal(
            interpolated_matrix(6500, 2850, 6500, M_COLOR_MATRIX_1,
                                M_COLOR_MATRIX_2),
            M_COLOR_MATRIX_2,
            decimal=7)

        np.testing.assert_almost_equal(
            interpolated_matrix(10000, 2850, 6500, M_COLOR_MATRIX_1,
                                M_COLOR_MATRIX_2),
            M_COLOR_MATRIX_2,
            decimal=7)
...
camera_neutral_to_xy` definition.
        ...
        np.testing.assert_almost_equal(
            camera_neutral_to_xy(
                np.array([0.39667111, 1.00000000, 0.62474378]), 2850, 6500,
                M_COLOR_MATRIX_1, M_COLOR_MATRIX_2, M_CAMERA_CALIBRATION_1,
                M_CAMERA_CALIBRATION_2, ANALOG_BALANCE),
            np.array([0.32816244, 0.34698169]),
            decimal=7)
