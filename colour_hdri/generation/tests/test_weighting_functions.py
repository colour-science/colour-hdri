...
normal_distribution_function` definition.
        ...
        np.testing.assert_almost_equal(
            ...
            np.array(
                [0.00386592, 0.03470859, 0.18002174, 0.53940751, 0.93371212,
        ...
        np.testing.assert_almost_equal(
            ...
            np.array(
                [1.00000000, 0.99384617, 0.97561098, 0.94595947, 0.90595519,
                 0.85699689, 0.80073740, 0.73899130, 0.67363846, 0.60653066]),
            decimal=7)  # yapf: disable

        np.testing.assert_almost_equal(
            normal_distribution_function(np.linspace(0, 1, 10), 0.5, 0.5),
            np.array(
                [0.60653066, 0.73899130, 0.85699689, 0.94595947, 0.99384617,
                 0.99384617, 0.94595947, 0.85699689, 0.73899130, 0.60653066]),
            decimal=7)  # yapf: disable
...
class TestHatFunction(unittest.TestCase):
    ...
    def test_hat_function(self):
        ...
        np.testing.assert_almost_equal(
            ...
            np.array(
                [0.00000000, 0.95099207, 0.99913557, 0.99999812, 1.00000000,
                 1.00000000, 0.99999812, 0.99913557, 0.95099207, 0.00000000]),
            decimal=7)  # yapf: disable
...
weighting_function_Debevec1997` definition.
        ...
        np.testing.assert_almost_equal(
            ...
            np.array(
                [0.00000000, 0.23273657, 0.48849105, 0.74424552, 1.00000000,
                 1.00000000, 0.74424552, 0.48849105, 0.23273657, 0.00000000]),
            decimal=7)  # yapf: disable
        ...
        np.testing.assert_almost_equal(
            ...
            np.array(
                [0.00000000, 0.25000000, 0.50000000, 0.75000000, 1.00000000,
                 1.00000000, 0.75000000, 0.50000000, 0.25000000, 0.00000000]),
            decimal=7)  # yapf: disable

        np.testing.assert_almost_equal(
            weighting_function_Debevec1997(np.linspace(0, 1, 10), 0.25, 0.75),
            np.array(
                [0.00000000, 0.00000000, 0.00000000, 0.42857143, 1.00000000,
                 1.00000000, 0.42857143, 0.00000000, 0.00000000, 0.00000000]),
            decimal=7)  # yapf: disable
